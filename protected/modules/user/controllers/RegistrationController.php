...
class RegistrationController extends Controller
{
	...
	public function actionRegistration() {
            ...
            $labels_array = array("Work","Important","Personal","Red","Blue","Green","Yellow","Orange","Gray","Purple");
		    ...
		    if (Yii::app()->user->id) {
		    	...
		    	if(isset($_POST['RegistrationForm'])) {
					...
					if($model->validate()&&$profile->validate())
					{
						...
						if ($model->save()) {
							for($i=0;$i<10;$i++) {
								$labels_model = new IcbacLabels;	
								$labels_model->user_id = $model->id;
								$labels_model->label_name = $labels_array[$i];
								$labels_model->label_id = $i;
								$labels_model->save();
							}
